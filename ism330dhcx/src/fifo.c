...
ism330dhcx_fifo_s ism330dhcx_fifo__get_default_s()
{
    return (ism330dhcx_fifo_s){
        ...
        .data_out_x = {
            .ADR = {
                .byte._0 = ISM330DHCX_RM__FIFO_DATA_OUT_X_L,
                .byte._1 = ISM330DHCX_RM__FIFO_DATA_OUT_X_H,
            },
            .val = 0x0000u,
        },
        ...
        .data_out_y = {
            .ADR = {
                .byte._0 = ISM330DHCX_RM__FIFO_DATA_OUT_Y_L,
                .byte._1 = ISM330DHCX_RM__FIFO_DATA_OUT_Y_H,
            },
            .val = 0x0000u,
        },
        ...
        .data_out_z = {
            .ADR = {
                .byte._0 = ISM330DHCX_RM__FIFO_DATA_OUT_Z_L,
                .byte._1 = ISM330DHCX_RM__FIFO_DATA_OUT_Z_H,
            },
            .val = 0x0000u,
        },
    };
